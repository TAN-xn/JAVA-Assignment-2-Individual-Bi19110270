...
// Let the user fill the COVID-19 2020 Volunteer Registration Form (Doctor)
...
class MyDoctorForm extends JFrame implements ActionListener { 
    ...
    {   
        ...
        mybox.setBackground(Color.PINK); 
    ...
    {   
        ...
        { 
            ...
            {   
                ...
                // Create an icon and a dialog that show a message
                JOptionPane.showMessageDialog(null, "Dear Doctor,\nYour registration is CONFIRM !", "Message", JOptionPane.INFORMATION_MESSAGE, icon5);
                
                // Create a text file for enable to read the input from external storage file 
                // and write the output to external file
                try
                { writer = new FileWriter("Covid-19 Volunteer-Doctor.txt", true);
                  writer.write("Covid-19 2020 Volunteer Registration Form Personal Detail(Doctor)");
...
{ 
    ...
    { 
        MyDoctorForm thisform = new MyDoctorForm(); 
    } 
} 